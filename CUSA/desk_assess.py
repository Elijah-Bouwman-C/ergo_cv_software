...
def main():
    ...
    #Config video
    video_path = get_height_weight_video_path()
    ...
    with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
        while cap.isOpened():
            ...
            if results.pose_landmarks:
                ...
                knee_angle,upper_arm_angle,lower_arm_angle = get_greatest(left_leg_angle,right_leg_angle,left_upper_arm_angle,right_upper_arm_angle,left_lower_arm_angle,right_lower_arm_angle)
                ...
                if current_time - last_saved_time >= 1:
                    ...
                    data['problematic_areas'] = get_desk_params(data)
